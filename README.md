...
If there's ***any*** problems with the defination, please ask it *clearly* from the github issue, like "There's member XXX in class XXX that typed string."(Please say the type).
...
如果定义脚本有__*任何*__的问题，请在GitHub上的Issue上把问题问的*尽量清楚*，像“类XXX有成员XXX，它的类型是string。”
